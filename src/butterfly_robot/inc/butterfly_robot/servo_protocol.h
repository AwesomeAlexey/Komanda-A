...
namespace servocmd
{
    ...
    {
        static_assert(sizeof(_magic) - 1 <= sizeof(CmdPack::magic), "incorrect servocmd::_magic");
    ...
    {
        static_assert(sizeof(_magic) - 1 <= sizeof(InfoPack::magic), "incorrect servocmd::_magic");
        memcpy(pack.magic, _magic, sizeof(_magic) - 1);
    }
